...
for i in range(0, 3):
    ...
    #if partidas == 3:
if vitoria >= 2:
    novamente = str(input('parabéns, você venceu! quer jogar novamente? (s/n) ').capitalize().strip())
    
else:
    novamente = str(input('jogo encerrado! a máquina venceu! quer jogar novamente? (s/n) ').capitalize().strip()) 
